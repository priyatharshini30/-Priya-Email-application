...
public class Email {
	...
	System.out.println("Email account created for:"  + this.fristName +""+ this.lastName);
	...
	else if(department == 2) { return "Development"; }	else if(department == 3) { return "Accounting"; }
	...
	public void info() {
	System.out.println("Name: "+ this.fristName + "" + this.lastName);
	System.out.println("Email address is: " + this.fristName.toLowerCase() + "." + this.lastName.toLowerCase() + "@" + this.department + "." + comName );
